...
func TestValidateRuntimeSettings(t *testing.T) {
	...
	tests := []RuntimeSettings{{DefaultContextLimit: 3, AIRequestTimeoutSeconds: 90, MessageRetentionDays: 90}, {DefaultContextLimit: 20, AIRequestTimeoutSeconds: 601, MessageRetentionDays: 90}, {DefaultContextLimit: 20, AIRequestTimeoutSeconds: 90, MessageRetentionDays: 0}}
