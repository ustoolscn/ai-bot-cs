...
func TestSignatureAndParse(t *testing.T) {
	body := []byte(`{"id":"evt1","op":0,"t":"GROUP_AT_MESSAGE_CREATE","d":{"id":"m1","group_openid":"g1","content":" hi ","author":{"member_openid":"u1"}}}`)
	ts := "123"
	...
	if m.ConversationID != "g1" || m.Text != "hi" || !ShouldReply(m.EventType) {
