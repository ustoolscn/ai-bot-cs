...
export const mockModels: ModelProfile[] = [
  { id: 'chat-qwen-plus', name: '通用对话模型', kind: 'chat', provider: 'OpenAI Compatible', model: 'qwen-plus', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••7K2A', status: 'online', latency: 720, webSearchMode: 'qwen', extraBody: {} },
  { id: 'chat-qwen-max', name: '高质量对话模型', kind: 'chat', provider: 'OpenAI Compatible', model: 'qwen-max', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••9M4P', status: 'online', latency: 930, webSearchMode: 'disabled', extraBody: {} },
  { id: 'embedding-v3', name: '知识向量模型', kind: 'embedding', provider: 'OpenAI Compatible', model: 'text-embedding-v3', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••2H8N', status: 'online', latency: 180, dimension: 1024, webSearchMode: 'disabled', extraBody: {} },
]
