...
export const mockModels: ModelProfile[] = [
  { id: 'chat-qwen-plus', name: '通用对话模型', kind: 'chat', provider: 'OpenAI Compatible', model: 'qwen-plus', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••7K2A', status: 'online', latency: 720 },
  { id: 'chat-qwen-max', name: '高质量对话模型', kind: 'chat', provider: 'OpenAI Compatible', model: 'qwen-max', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••9M4P', status: 'online', latency: 930 },
  { id: 'embedding-v3', name: '知识向量模型', kind: 'embedding', provider: 'OpenAI Compatible', model: 'text-embedding-v3', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', maskedKey: 'sk-••••••••2H8N', status: 'online', latency: 180, dimension: 1024 },
]

export const mockConversations: Conversation[] = [
  { id: 'group-1001', botId: 'bot-qq-service', name: '产品运营交流群', platform: 'QQ', type: 'group', triggerMode: 'mention_only', messageCount: 12842, memberCount: 486, contextLimit: 20, knowledgeBaseNames: ['产品手册库', '常见问题库'], knowledgeBaseIds: ['kb-products', 'kb-faq'], chatProfileId: 'chat-qwen-plus', systemPrompt: '你是群内的 AI 助手，请根据知识库准确、简洁地回答问题。', lastActiveAt: '刚刚', enabled: true },
  { id: 'group-1002', botId: 'bot-knowledge', name: '售后服务群', platform: 'QQ', type: 'group', triggerMode: 'mention_only', messageCount: 8631, memberCount: 238, contextLimit: 20, knowledgeBaseNames: ['售后知识库'], knowledgeBaseIds: ['kb-after-sale'], chatProfileId: 'chat-qwen-max', systemPrompt: '你是售后服务助手，请优先依据售后知识库回答。', lastActiveAt: '1 分钟前', enabled: true },
  { id: 'group-1003', botId: 'bot-campaign', name: '夏季活动执行群', platform: 'QQ', type: 'group', triggerMode: 'mention_only', messageCount: 3210, memberCount: 92, contextLimit: 12, knowledgeBaseNames: ['活动文案库'], knowledgeBaseIds: ['kb-campaign'], chatProfileId: 'chat-qwen-plus', systemPrompt: '你是活动执行助手，请使用简洁、明确的活动话术。', lastActiveAt: '12 分钟前', enabled: true },
  { id: 'c2c-88', botId: 'bot-qq-service', name: '用户 8G7X', platform: 'QQ', type: 'c2c', triggerMode: 'always', messageCount: 46, memberCount: 1, contextLimit: 20, knowledgeBaseNames: ['常见问题库'], knowledgeBaseIds: ['kb-faq'], chatProfileId: 'chat-qwen-plus', systemPrompt: '你是私聊智能助手，请准确回答用户问题。', lastActiveAt: '18 分钟前', enabled: true },
]

export const mockMessages: MessageRecord[] = [
  { id: 'msg-001', time: '2025-05-20 15:24:31', botName: '客服小Q', conversationName: '产品运营交流群', sender: '林晓', question: '@客服小Q 怎么申请七天无理由退款？', answer: '您可以在订单详情中发起退款申请，商品需保持完好。具体步骤如下…', eventType: 'GROUP_AT_MESSAGE_CREATE', model: 'qwen-plus', status: 'success', latency: 1750, tokens: 842, knowledgeHits: 5, deliveryStatus: 'success', traceId: 'tr_01JVC8P7Q2A' },
  { id: 'msg-002', time: '2025-05-20 15:24:28', botName: '客服小Q', conversationName: '售后服务群', sender: '周周', question: '@客服小Q 保修期是多久？', answer: '根据售后政策，主机提供一年有限保修服务。', eventType: 'GROUP_AT_MESSAGE_CREATE', model: 'qwen-plus', status: 'success', latency: 1390, tokens: 516, knowledgeHits: 3, deliveryStatus: 'success', traceId: 'tr_01JVC8NX8KQ' },
  { id: 'msg-003', time: '2025-05-20 15:24:24', botName: '知识助手', conversationName: '产品运营交流群', sender: '小川', question: '@知识助手 企业版支持哪些权限？', answer: '企业版支持角色权限、审计日志、知识隔离等功能。', eventType: 'GROUP_AT_MESSAGE_CREATE', model: 'qwen-max', status: 'success', latency: 1980, tokens: 1032, knowledgeHits: 8, deliveryStatus: 'success', traceId: 'tr_01JVC8K16MY' },
  { id: 'msg-004', time: '2025-05-20 15:24:21', botName: '客服小Q', conversationName: '售后服务群', sender: 'Miya', question: '@客服小Q 帮我查询订单', answer: '', eventType: 'GROUP_AT_MESSAGE_CREATE', model: '—', status: 'failed', latency: 5510, tokens: 0, knowledgeHits: 1, deliveryStatus: 'failed', traceId: 'tr_01JVC8G0A19' },
]
